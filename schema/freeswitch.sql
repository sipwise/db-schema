...
/*!50001 CREATE VIEW `basic_calls` AS SELECT
 ...
 NULL AS `dest`,
 NULL AS `presence_id`,
 NULL AS `presence_data`,
 NULL AS `accountcode`,
 NULL AS `callstate`,
 NULL AS `callee_name`,
 NULL AS `callee_num`,
 NULL AS `callee_direction`,
 NULL AS `call_uuid`,
 NULL AS `hostname`,
 NULL AS `sent_callee_name`,
 NULL AS `sent_callee_num`,
 NULL AS `b_uuid`,
 NULL AS `b_direction`,
 NULL AS `b_created`,
 NULL AS `b_created_epoch`,
 NULL AS `b_name`,
 NULL AS `b_state`,
 NULL AS `b_cid_name`,
 NULL AS `b_cid_num`,
 NULL AS `b_ip_addr`,
 NULL AS `b_dest`,
 NULL AS `b_presence_id`,
 NULL AS `b_presence_data`,
 NULL AS `b_accountcode`,
 NULL AS `b_callstate`,
 NULL AS `b_callee_name`,
 NULL AS `b_callee_num`,
 NULL AS `b_callee_direction`,
 NULL AS `b_sent_callee_name`,
 NULL AS `b_sent_callee_num`,
 NULL AS `call_created_epoch` */;
...
/*!50001 CREATE VIEW `detailed_calls` AS SELECT
 ...
 NULL AS `dest`,
 NULL AS `application`,
 NULL AS `application_data`,
 NULL AS `dialplan`,
 NULL AS `context`,
 NULL AS `read_codec`,
 NULL AS `read_rate`,
 NULL AS `read_bit_rate`,
 NULL AS `write_codec`,
 NULL AS `write_rate`,
 NULL AS `write_bit_rate`,
 NULL AS `secure`,
 NULL AS `hostname`,
 NULL AS `presence_id`,
 NULL AS `presence_data`,
 ...
 NULL AS `b_ip_addr`,
 NULL AS `b_dest`,
 NULL AS `b_application`,
 NULL AS `b_application_data`,
 NULL AS `b_dialplan`,
 NULL AS `b_context`,
 NULL AS `b_read_codec`,
 NULL AS `b_read_rate`,
 NULL AS `b_read_bit_rate`,
 NULL AS `b_write_codec`,
 NULL AS `b_write_rate`,
 NULL AS `b_write_bit_rate`,
 NULL AS `b_secure`,
 NULL AS `b_hostname`,
 NULL AS `b_presence_id`,
 NULL AS `b_presence_data`,

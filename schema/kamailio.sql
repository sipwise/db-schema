...
CREATE TABLE `acc` (
  ...
  `src_leg` text DEFAULT NULL,
  `dst_leg` text DEFAULT NULL,
...
commit;
set autocommit=0;
INSERT INTO `subscriber` VALUES (1,'no_such_number','voip.sipwise.local','3141a404c8ea3225685c856639841817','236feed92d0f30e96c46e1f53ec8c5f3','44048240e652808415beba7afd895bf0','9bcb88b6-541a-43da-8fdc-816f5557ff93','','1970-01-01 00:00:01');
commit;
set autocommit=0;
commit;
set autocommit=0;
